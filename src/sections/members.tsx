                                ...
                                <div className="p-5">
                                    ...
                                    <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-3 w-1/3 justify-center">
                                            {/* Facebook */}
                                            <a href={member.facebook} aria-label={`${member.name} Facebook profile`} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-400 transition-colors duration-300">
                                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                                </svg>
                                            </a>
                                            {/* Instagram */}
                                            <a href={member.instagram} aria-label={`${member.name} Instagram profile`} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-400 transition-colors duration-300">
                                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                            ...
                                            {/* Mail */}
                                            <a href={member.email} aria-label={`Email ${member.name}`} className="text-gray-500 hover:text-green-400 transition-colors duration-300">
