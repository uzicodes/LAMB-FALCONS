                                ...
                                <div className="p-5">
                                    ...
                                    <div className="mt-4 pt-3 border-t border-[#f8f4e8]/5 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-3 w-1/3 justify-center">
                                            {/* Facebook */}
                                            <a href={member.facebook} aria-label={`${member.name} Facebook profile`} target="_blank" rel="noopener noreferrer" className="text-[#f8f4e8]/40 hover:text-[#d2e823] transition-colors duration-300">
                                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                                </svg>
                                            </a>
                                            {/* Instagram */}
                                            <a href={member.instagram} aria-label={`${member.name} Instagram profile`} target="_blank" rel="noopener noreferrer" className="text-[#f8f4e8]/40 hover:text-[#d2e823] transition-colors duration-300">
                                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                            ...
                                            {/* Mail */}
                                            <a href={member.email} aria-label={`Email ${member.name}`} className="text-[#f8f4e8]/40 hover:text-[#d2e823] transition-colors duration-300">
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                                </svg>
                                            </a>
                                        </div>
                                        <span className="text-xl font-black text-[#f8f4e8]/[0.15] leading-none w-1/3 text-right">
                                            {member.number}
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div className="relative rounded-3xl border border-[#f8f4e8]/10 bg-gradient-to-br from-[#f8f4e8]/[0.03] to-[#f8f4e8]/[0.01] p-10 md:p-16 text-center overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <button
                                ...
                                className="inline-flex px-10 py-4 bg-[#d2e823] hover:bg-[#e0f040] text-[#0a2a1f] font-semibold text-sm uppercase tracking-widest rounded-full transition-all duration-300 hover:shadow-[0_0_50px_rgba(210,232,35,0.4)]"
                            >
                                Apply Now
                            </button>
                        </div>
                ...
                {showRecruitmentPopup && (
                    <>
                        <m.div
                            ...
                            className="fixed inset-0 z-[100] bg-[#061a13]/80 backdrop-blur-md cursor-pointer"
                        />
                        <m.div
                        ...
                        >
                            <div className="relative w-full max-w-lg bg-[#0a2a1f] border border-[#15442f] rounded-3xl p-8 md:p-10 overflow-hidden shadow-2xl pointer-events-auto">
                                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#d2e823] via-[#e0f040] to-[#d2e823]" />
                                <div className="absolute top-4 right-4">
                                    <button
                                        type="button"
                                        aria-label="Close recruitment popup"
                                        onClick={() => setShowRecruitmentPopup(false)}
                                        className="p-2 hover:bg-[#f8f4e8]/5 rounded-full transition-colors text-[#f8f4e8]/50 hover:text-[#f8f4e8]"
                                    >
                                        <X size={20} />
                                    </button>
                                </div>
                                ...
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <p className="text-[#f8f4e8]/50 leading-relaxed mb-8">
                                        Thank you for your interest in joining the <span className="text-[#d2e823] font-semibold">LAMB FALCONS</span>.
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setShowRecruitmentPopup(false)}
                                        className="w-full py-4 bg-[#f8f4e8]/5 border border-[#f8f4e8]/10 hover:bg-[#f8f4e8]/10 text-[#f8f4e8] font-bold uppercase tracking-[0.2em] text-xs rounded-xl transition-all duration-300"
                                    >
                                        Understood
                                    </button>
                                </div>
