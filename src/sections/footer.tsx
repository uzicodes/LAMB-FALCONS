    ...
    <footer className="relative mt-12 md:mt-24 pt-8 pb-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 className="text-2xl font-black tracking-wider leading-none font-tanker">
                      <span className="text-[#f8f4e8]">LAMB</span>{" "}
                      <span className="text-[#d2e823]">FALCONS</span>
                    </h3>
            ...
            <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
              {Object.entries(FOOTER_LINKS).map(([category, links]) => (
                <div key={category} className="flex flex-col">
                  <h4 className="text-xs font-bold tracking-[0.2em] uppercase text-[#d2e823] mb-5">
                    {category}
                  </h4>
        ...
        <div className="relative pt-12 md:pt-16 pb-2 text-center select-none pointer-events-none overflow-hidden">
          ...
          <div className="mx-auto mt-2 w-48 sm:w-80 h-px bg-gradient-to-r from-transparent via-[#d2e823]/30 to-transparent" />
        </div>
      </div>
    </footer>
  );
