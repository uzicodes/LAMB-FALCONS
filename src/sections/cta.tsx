      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10">
            <span className="inline-block text-xs font-semibold tracking-[0.3em] uppercase text-[#d2e823]/50 mb-4">
              Be Part of Us
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-wider text-[#d2e823]/70 mb-4 font-tanker">
              Ready to Fly?
            </h2>
